            ...
            <div class="p-3 py-5">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="user_name" class="form-control" placeholder="first name" value="{{ auth()->user()->user_name }}">
                    </div>
                    <div class="col-md-6">
                        <label class="labels">Email</label>
                        <input type="text" name="user_email" disabled class="form-control" value="{{ auth()->user()->user_email }}" placeholder="Email">
                    </div>
                </div>
                <div class="row mt-2">
                    <div class="col-md-6">
