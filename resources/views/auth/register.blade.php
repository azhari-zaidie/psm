                        ...
                        <div class="p-5">
                            ...
                            <form action="{{route('register.save') }}" method="POST" class="user">
                                ...
                                <div class="form-group">
                                    <input name="user_name" type="text" class="form-control form-control-user @error('user_name')is-invalid @enderror" id="exampleFirstName" placeholder="Username">
                                    @error('user_name')
                                    <span class="invalid-feedback">
                                        {{$message}}
                                    </span>
                                    @enderror
                                    <input name="user_role" type="text" value="admin" class="form-control form-control-user" id="exampleFirstName" placeholder="Username" hidden>
                                </div>
                                <div class="form-group">
                                    <input name="user_email" type="email" class="form-control form-control-user @error('user_email')is-invalid @enderror" id="exampleInputEmail" placeholder="Email Address">
                                    @error('user_email')
                                    <span class="invalid-feedback">
                                        {{$message}}
                                    </span>
